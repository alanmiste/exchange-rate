...
//since it will be a single fetch call 
//it's going to use this mock fetch method 
//which will simulate a short delay 
//and return with exchange rates after a short period
